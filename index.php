        ...
        <div class="card text-center container">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a class="<?php echo (isset($_GET['path']) && $_GET['path'] == "projects") ? "nav-link active" : "nav-link";?>"href="./?path=projects">Projects</a>
                    </li>
                    <li class="nav-item">
                        <a class="<?php echo (isset($_GET['path']) && $_GET['path'] == "people") ? "nav-link active" : "nav-link";?>" href="./?path=people">People</a>
                    </li>
                </ul>
            </div>
            <div>
